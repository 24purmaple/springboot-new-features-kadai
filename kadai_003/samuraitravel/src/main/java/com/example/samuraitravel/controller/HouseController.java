...
public class HouseController {
	...
	public String show(@PathVariable(name = "id") Integer id, Model model, @AuthenticationPrincipal UserDetailsImpl userDetailsImpl) {
		...
		boolean hasUserAlreadyReviewed = false;//追加//
		...
		model.addAttribute("hasUserAlreadyReviewed", hasUserAlreadyReviewed);//追加//
		model.addAttribute("newReviews", newReviews);//追加//
		model.addAttribute("totalReviewCount", totalReviewCount);//追加//
		model.addAttribute("favorite", favorite);//追加//
		model.addAttribute("hasUserAlreadyFavorited", hasUserAlreadyFavorited);//追加//
